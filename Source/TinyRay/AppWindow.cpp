...
{
	if(m_pRayTracer->m_traceflag != RayTracer::NO_TRACE)
	{
	...
	else
	{
		...
		m_pPathTracer->DoRayTrace(m_pScene);
		glDrawPixels(m_width, m_height, GL_RGBA, GL_FLOAT, pBuffer);
...
BOOL AppWindow::KeyUp(WPARAM key)
{
	...
	case VK_F1:
		...
		m_pPathTracer->m_traceflag = PathTracer::NO_TRACE;
		break;
	case VK_F2:
	...
	case VK_F6:
		...
		break;
	case 0x31:
		m_pRayTracer->m_traceflag = (RayTracer::TraceFlags)(RayTracer::NO_TRACE);
		m_pPathTracer->SetSPP(10);
		m_pPathTracer->m_traceflag = (PathTracer::TraceFlags)(PathTracer::TRACE_DIFFUSE);
		break;
	case 0x32:
		m_pRayTracer->m_traceflag = (RayTracer::TraceFlags)(RayTracer::NO_TRACE);
		m_pPathTracer->SetSPP(100);
		m_pPathTracer->m_traceflag = (PathTracer::TraceFlags)(PathTracer::TRACE_DIFFUSE);
		break;
	case 0x33:
		m_pRayTracer->m_traceflag = (RayTracer::TraceFlags)(RayTracer::NO_TRACE);
		m_pPathTracer->SetSPP(1000);
		m_pPathTracer->m_traceflag = (PathTracer::TraceFlags)(PathTracer::TRACE_DIFFUSE);
		break;
	case 0x34:
		m_pRayTracer->m_traceflag = (RayTracer::TraceFlags)(RayTracer::NO_TRACE);
		m_pPathTracer->SetSPP(10);
		m_pPathTracer->m_traceflag = (PathTracer::TraceFlags)(PathTracer::TRACE_DIFFUSE | PathTracer::TRACE_GLOSS);
		break;
	case 0x35:
		m_pRayTracer->m_traceflag = (RayTracer::TraceFlags)(RayTracer::NO_TRACE);
		m_pPathTracer->SetSPP(100);
