...
void PrintUsage()
{
	...
	printf("Use 1-6 keys to switch path trace complexity\n");
	printf("NOTE: Editing the value in the SetSPP(int) method for keys 7 and 8 inside AppWindow.cpp \n");
	printf("\tallows for custom sample values\n");
	...
	printf("1: Path trace, diffuse only, 10 spp\n");
	printf("2: Path trace, diffuse only, 100 spp\n");
	printf("3: Path trace, diffuse only, 1000 spp\n");
	printf("4: Path trace, gloss, 10 spp\n");
	printf("5: Path trace, gloss, 100 spp\n");
	printf("6: Path trace, gloss, 1000 spp\n");
	printf("7: Path trace, diffuse only, 500 spp default\n");
	printf("8: Path trace, gloss, 500 spp default\n");
}
